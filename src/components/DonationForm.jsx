          ...
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-3xl font-display font-bold text-gray-800">
                {reward ? `Donar por ${reward.name}` : '¡Apoya Nuestras Voces!'}
              </h2>
            ...
            <label className="flex items-start space-x-3">
              ...
              <div>
                <span className="text-gray-700">
                  ...
                  <Link to="/terminos" target="_blank" className="text-primary-teal hover:underline font-semibold">
                    Términos y Condiciones
                  </Link>
                  {' '}y el{' '}
                  <Link to="/privacidad" target="_blank" className="text-primary-teal hover:underline font-semibold">
                    Aviso de Privacidad
                  </Link>
                  {' '}*
                </span>
