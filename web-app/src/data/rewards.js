export const rewards = [
  ...
  },
  {
    id: 4,
    level: 4,
    name: "Voz que Acompaña",
    amount: 1000,
    color: "orange",
    icon: "🟠",
    benefits: [
      "Todo lo anterior",
      "Acceso a material extra del 'detrás de cámaras'",
